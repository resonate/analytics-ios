...
analytics-ios is an iOS client for Resonate. Adapated from Segment.
...
<div align="center">
  <img src="https://user-images.githubusercontent.com/5971538/74848080-a0bdf680-5304-11ea-8f87-f6c6e504a1ab.png"/>
...
ResonateAnalytics is available through [CocoaPods](http://cocoapods.org).

### CocoaPods

```ruby
pod "ResonateAnalytics", "3.8.0-beta.2"
```

### Carthage

```ruby
github "resonate/analytics-ios" "3.8.0-beta.2"
```

## Documentation

More detailed documentation is available at [https://support.resonate.com/](https://support.resonate.com/).
